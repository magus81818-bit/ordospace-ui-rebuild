...
check('known baseline request failures are separated from new failures',browser.knownBaselineRequestFailures.every(item=>item.baselineCount>0&&item.currentCount>0)&&browser.newRequestFailures.length===0);
